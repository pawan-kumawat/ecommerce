...
class TTextTheme{
  ...
  static TextTheme lightTextTheme = TextTheme(
    ...
    labelSmall: TextStyle().copyWith(fontSize: 12.0, fontWeight: FontWeight.normal,color: Colors.black.withOpacity(0.5)),
  );
  static TextTheme darkTextTheme = TextTheme(
    ...
    labelSmall: TextStyle().copyWith(fontSize: 12.0, fontWeight: FontWeight.normal,color: Colors.white.withOpacity(0.5)),
  );
